...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 27 2019 г., 04:06
...
CREATE TABLE `teachers` (
  ...
  `deportament` varchar(25) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `teachers` (`id`, `teacher_name`, `teacher_surname`, `teacher_three_name`, `deportament`) VALUES
(1, 'andrey', 'lamzuk', 'alexeevich', '1'),
(2, 'svetlana', 'kazakova', 'anatolievna', '1'),
(3, 'andrey', 'ganja', 'pavlovich', '0'),
(6, 'georgiy', 'perelman', 'jakovlevich', '1');
